...
VALUES
  ('u1111111-1111-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', NULL, 'hocluongvan88@gmail.com', 'Lương Văn Học', 'SUPER_ADMIN', 'Ban Điều Hành & Quản Trị Tối Cao', 'Chief Executive Officer & Super Admin', '+84 988 888 888', TRUE, TRUE),
  ('u2222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000001', NULL, 'hocluongvan25@gmail.com', 'Nguyễn Tuấn Anh', 'OPS_MANAGER', 'Ban Quản Trị & Vận Hành Tổng Thể', 'Amazon Operations Director', '+84 925 252 525', TRUE, TRUE),
  ('u3333333-3333-3333-3333-333333333333', '00000000-0000-0000-0000-000000000001', NULL, 'luonghoangminh88@gmail.com', 'Lương Hoàng Minh', 'PPC_SPECIALIST', 'Team Quảng Cáo & Growth PPC', 'Lead PPC & Growth Engineering Specialist', '+84 988 123 456', FALSE, TRUE),
  ('u4444444-4444-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', NULL, 'anhnguyen94@gmail.com', 'Ánh Nguyễn', 'SUPPLY_CHAIN_SPECIALIST', 'Team Kho Vận & Chuỗi Cung Ứng FBA', 'Senior FBA Logistics & 3PL Manager', '+84 994 949 494', FALSE, TRUE),
  ('u5555555-5555-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', NULL, 'hocluongvan26@gmail.com', 'Trần Thu Hà', 'BRAND_CS_SPECIALIST', 'Team Listing, CRO & Chăm Sóc Khách Hàng', 'Brand Experience & Listing Optimization Manager', '+84 926 262 626', FALSE, TRUE),
  ('u6666666-6666-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', NULL, 'hocluongvan2588@gmail.com', 'Lê Hoàng Nam', 'COMPLIANCE_SPECIALIST', 'Team Pháp Lý, FDA & Soạn Đơn Kháng Cáo POA', 'Head of Amazon Compliance & Policy Counsel', '+84 925 888 888', TRUE, TRUE),
  ('u7777777-7777-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', NULL, 'hocluongvan2788@gmail.com', 'Phạm Minh Trang', 'ACCOUNT_EXECUTIVE', 'Team Quản Lý Khách Hàng & Đối Tác', 'Senior Account Executive', '+84 927 888 888', FALSE, TRUE),
  ('u8888888-8888-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'hocluongvan22@gmail.com', 'Nguyễn Văn Hùng', 'CLIENT_SUPPLIER', 'Công ty Cổ phần Vinacacao Việt Nam', 'Tổng Giám Đốc (CEO)', '+84 908 123 456', FALSE, TRUE),
  ('u9999999-9999-1111-1111-111111111111', '00000000-0000-0000-0000-000000000001', '22222222-2222-2222-2222-222222222222', 'hocluongvvan33@gmail.com', 'Trần Thị Thu Thảo', 'CLIENT_SUPPLIER', 'Công ty TNHH Thảo Mộc An An', 'Nhà Sáng Lập (Founder)', '+84 912 345 678', FALSE, TRUE)
