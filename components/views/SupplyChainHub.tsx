            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <h2 className="text-base font-bold text-slate-900">
                  Bàn Điều Phối Xử Lý Hàng Hoàn & Thu Hồi Vốn (Vexim Reverse Logistics Decision Desk)
                </h2>
                <span className="rounded bg-indigo-100 text-indigo-900 px-2 py-0.5 text-[10px] font-mono font-bold">
                  3PL API / EDI 947 Ingest Stream
                </span>
              </div>
              <p className="text-xs text-slate-500 max-w-3xl">
                3PL tại Mỹ bắn dữ liệu kiểm định về qua API/EDI ➔ Chuyên viên Vexim ra quyết định thương mại (Tái xuất FBA / Thanh lý) ➔ Hệ thống phát Lệnh Work-Order tự động sang 3PL và cộng tiền thu hồi vào P&L Doanh nghiệp.
              </p>
            </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2 shrink-0">
                    {item.status === 'INSPECTED_AT_3PL' || item.status === 'TRANSIT_TO_3PL' ? (
                      <div className="flex items-center gap-1.5">
                        <button
                          onClick={() => gradeAndRelabelItem(item.id, 'GRADE_A_NEW', 'Đã gửi lệnh Work-Order sang 3PL: Thay hộp mới + Dán lại tem FNSKU ($0.35/sp) để châm ngược lại FBA.')}
                          ...
                          title="Phát Lệnh Work-Order qua API yêu cầu 3PL thay hộp và dán lại tem FNSKU"
                        >
                          🚀 Phát Lệnh Tái Xuất FBA (Grade A)
                        </button>
                        <button
                          onClick={() => gradeAndRelabelItem(item.id, 'GRADE_B_LIQUIDATE', 'Đã gửi lệnh Work-Order sang 3PL: Bàn giao lô hàng cho đơn vị thanh lý sỉ tại Los Angeles.')}
                          ...
                          title="Phát Lệnh Work-Order yêu cầu 3PL xuất bán thanh lý thu hồi 55% vốn"
                        >
                          Phát Lệnh Thanh Lý (Grade B)
                        </button>
                      </div>
